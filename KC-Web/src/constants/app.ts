...
export const SERVER_ACTIVITY_EVENT_TYPES = [
  ...
  "certificate.server_renewed",
  "auth.invalid_token",
  "auth.api_key_rejected",
  "auth.organization_context_missing",
  "auth.organization_resolution_failed",
  "auth.internal_trust_violation",
  "auth.permission_denied",
  "auth.login_failed",
  "auth.oidc_exchange_failed",
  "auth.oauth2_exchange_failed",
] as const;
