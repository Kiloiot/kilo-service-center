...
export const ERR_AUTH_ORG_REQUIRED = 'Authentication failed: no organization membership found.';
export const ERR_AUTH_CALLBACK_MISSING_CODE = 'Authentication failed: missing authorization code.';
export const ERR_AUTH_CALLBACK_EXCHANGE_FAILED = 'Authentication failed: could not complete login.';
export const ERR_AUTH_PROFILE_LOAD_FAILED = 'Authentication failed: could not load user profile.';
...
export const ERR_LOAD_BASE_STATIONS = 'Failed to load base stations. Please try again.';
export const ERR_LOAD_BS_DETAILS = 'Failed to load base station details';
export const ERR_UPDATE_BS_EUI = 'Failed to update base station EUI. Please try again.';
export const ERR_BS_EUI_EXISTS = 'A base station with this EUI already exists.';
export const ERR_BS_NOT_FOUND = 'Base station not found. It may have been deleted.';
...
export const ERR_DELETE_BASE_STATION = 'Failed to delete base station. Please try again.';
export const ERR_CREATE_BASE_STATION = 'Failed to create base station. Please try again.';
...
export const ERR_ATTACH_ENDPOINT = 'Failed to attach endpoint. Please try again.';
export const ERR_DETACH_ENDPOINT = 'Failed to detach endpoint. Please try again.';
export const ERR_UPDATE_ENDPOINT = 'Failed to update endpoint. Please try again.';
export const ERR_DELETE_ENDPOINT = 'Failed to delete endpoint. Please try again.';
...
export const LOG_PRE_DELETE_DETACH_FAILED = 'Pre-delete detach failed, attempting delete anyway:';
...
export const VAL_PAYLOAD_BASE64 = 'Invalid payload format. Must be valid base64';
...
export const HELPER_DL_CNT_DEPEND = 'Payloads are tied to specific packet counters';
...
export const CONFIRM_FLUSH_QUEUE = 'Revoke all pending downlink messages in the queue?';
...
export const HELPER_DL_PAYLOAD_ACK = 'Hex-encoded payload (leave empty for ACK-only)';
...
export const HELPER_DL_CNT_DEPEND_PAYLOADS = 'Each payload requires a matching packet counter';
...
export const ERR_NETWORK_ERROR = 'Network connection failed. Please check your connection.';
export const ERR_GENERIC_ERROR = 'An unexpected error occurred. Please try again.';
export const ERR_TIMEOUT_ERROR = 'Request timed out. Please try again.';
export const ERR_UNAUTHORIZED = 'Your session has expired. Please log in again.';
...
export const HELPER_SC_URL = 'URL where the base station will connect for BSSCI protocol';
...
export const VAL_LAT_LON_PAIR = 'Both latitude and longitude are required, or leave both empty';
...
export const INSTR_STEP_1 = "1. Open your base station's configuration interface";
export const INSTR_STEP_2_HEADER = '2. Configure the following settings:';
export const INSTR_STEP_3 = '3. Save the configuration and restart your base station';
...
export const ENDPOINT_FORM = {
  ...
  DIALOG_SUBTITLE: 'Configure a new MIOTY end point with network keys and propagation settings',
  ...
  // Helper Text
  HELPER_EUI: '16 hex characters (e.g., 01-23-45-67-89-AB-CD-EF or 0123456789ABCDEF)',
  ...
  HELPER_SHORT_ADDR: 'Required. 4 hex chars, nonzero (0001-FFFF). From device provisioning.',
  ...
  HELPER_DEVICE_MODEL: 'Select a device model to enable automatic payload decoding via blueprints.',
  ...
  TOOLTIP_PRE_ATTACH: 'Immediately propagate to all base stations upon creation',
  TOOLTIP_DUAL_CHAN:
  ...
  ERROR_APP_KEY_FORMAT: 'Application key must be 32 hexadecimal characters if provided',
  ...
  ERROR_LAST_PACKET_CNT_REQUIRED: 'Last packet counter is required (BSSCI §3.8.1)',
  ...
  ALERT_REATTACH_PROMPT: 'Configuration changed. Re-attach to push updates to base stations?',
...
export const ENDPOINT_DETAILS = {
  ...
  DIALOG_DELETE_CONFIRM_PREFIX: 'Are you sure you want to delete this end point',
  DIALOG_DELETE_NOTE: 'The endpoint will be detached from all base stations before deletion.',
...
export const BASE_STATION_DETAILS = {
  ...
  DIALOG_DELETE_CONFIRM_PREFIX: 'Are you sure you want to delete the base station',
  DIALOG_DELETE_WARNING: 'This action cannot be undone.',
  // Edit dialog
  ...
  CERTIFICATES_HINT: 'Download the original certificates generated for this base station.',
...
export const SERVER_CERTIFICATES = {
  ...
  GENERATE_SUCCESS: 'Server certificates generated successfully. Restart the service to apply.',
  RENEW_SUCCESS: 'Server certificates renewed successfully. Restart the service to apply.',
  RESTART_REMINDER: 'A service restart is required for the new certificates to take effect.',
  CANCEL: 'Cancel',
} as const;
...
export const USER_FORM = {
  ...
  HELPER_ORGANIZATIONS: 'Assign the user to one or more organizations after creation',
  ERR_ADD_TO_ORG_PARTIAL: 'User created but failed to add to some organizations',
...
export const ERR_LOAD_ORGANIZATIONS = 'Failed to load organizations. Please try again.';
...
export const MSG_ORG_USER_REMOVED = 'User removed from organization successfully';
...
export const ORGANIZATIONS_PAGE = {
  ...
  ERR_NOT_MEMBER: 'You are not a member of this organization. Ask an administrator to add you.',
} as const;
...
export const ORG_USERS_PAGE = {
  ...
  // Errors
  ERR_CANNOT_REMOVE_LAST_OWNER: 'Cannot remove the last owner of an organization',
...
export const BLUEPRINT_LABELS = {
  ...
  CONFIRM_DELETE_MODEL: 'Delete this device model? All blueprints will also be deleted.',
  CONFIRM_DELETE_BLUEPRINT: 'Delete this blueprint? This action cannot be undone.',
  ...
  // Registry submission
  REGISTRY_DESCRIPTION_PLACEHOLDER: 'Describe the changes or purpose of this blueprint...',
...
export const REALTIME_MESSAGES = {
  ...
  // Context guards
  CONTEXT_INCOMPLETE: 'Realtime connection deferred: missing auth, org, or user context',
